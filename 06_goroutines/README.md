...
<details>
<summary>Немного про время</summary>
...
Вам нужно разделить всё по месяцам и расчёт каждого месяца запустить в отдельной горутине.
...
Мы предлагаем вам использовать пакет `time`. Если мы умеем время конвертировать в unix time, то можно его конвертировать и обратно:
